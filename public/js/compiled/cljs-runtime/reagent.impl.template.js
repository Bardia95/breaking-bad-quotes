...
var G__38019 = o;
(G__38019[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38099__delegate = function (args){
...
while (G__38100__i < G__38100__a.length) {G__38100__a[G__38100__i] = arguments[G__38100__i + 0]; ++G__38100__i;}
  args = new cljs.core.IndexedSeq(G__38100__a,0,null);
} 
return G__38099__delegate.call(this,args);};
G__38099.cljs$lang$maxFixedArity = 0;
G__38099.cljs$lang$applyTo = (function (arglist__38101){
var args = cljs.core.seq(arglist__38101);
return G__38099__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38029){
var map__38031 = p__38029;
...
var props = map__38031__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38031__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38037){
var map__38043 = p__38037;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38043__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__38055){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38056__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38056__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__38061 = jsprops;
(G__38061["defaultValue"] = value);

(G__38061["onChange"] = (function (p1__38052_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__38052_SHARP_);
}));
...
var vec__38063 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38063,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38063,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38063,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___38151 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___38151 == null)){
} else {
var key_38152 = temp__5739__auto___38151;
(jsprops["key"] = key_38152);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__38072){
var map__38073 = p__38072;
var map__38073__$1 = (((((!((map__38073 == null))))?(((((map__38073.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38073.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38073):map__38073);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38073__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__38078 = reagent.impl.template.__GT_NativeWrapper();
(G__38078["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__38079 = wrapped;
(G__38079["syntheticInput"] = true);

return G__38079;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__38080 = wrapped__$1;
(G__38080["syntheticOnChange"] = on_change);

return G__38080;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__38081 = wrapped__$2;
(G__38081["syntheticOnUpdate"] = on_update);
...
var len__4789__auto___38164 = arguments.length;
var i__4790__auto___38165 = (0);
while(true){
if((i__4790__auto___38165 < len__4789__auto___38164)){
args__4795__auto__.push((arguments[i__4790__auto___38165]));

var G__38166 = (i__4790__auto___38165 + (1));
i__4790__auto___38165 = G__38166;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38085){
var G__38086 = cljs.core.first(seq38085);
var seq38085__$1 = cljs.core.next(seq38085);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38086,seq38085__$1);
}));
...
break;
default:
var G__38168 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38168;
continue;
...
var n__4666__auto___38169 = a.length;
var i_38170 = (0);
while(true){
if((i_38170 < n__4666__auto___38169)){
(a[i_38170] = reagent.impl.template.as_element((a[i_38170])));

var G__38171 = (i_38170 + (1));
i_38170 = G__38171;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___38172 = a.length;
var i_38173 = (0);
while(true){
if((i_38173 < n__4666__auto___38172)){
var val_38174 = (a[i_38173]);
if(((cljs.core.vector_QMARK_(val_38174)) && ((reagent.impl.template.key_from_vec(val_38174) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38173] = reagent.impl.template.as_element(val_38174));

var G__38175 = (i_38173 + (1));
i_38173 = G__38175;
continue;
} else {
}
...
var ctx = ({});
var vec__38089 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38089,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38089,(1),null);
...
var G__38092 = (cljs.core.count(argv) - first_child);
switch (G__38092) {
case (0):
