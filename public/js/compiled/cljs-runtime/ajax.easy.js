...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__27723 = cljs.core.second(format);
var G__27724 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__27723,G__27724) : ajax.easy.keyword_response_format_element.call(null,G__27723,G__27724));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27726_SHARP_){
return ajax.easy.keyword_response_format_element(p1__27726_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__27727){
var map__27728 = p__27727;
var map__27728__$1 = (((((!((map__27728 == null))))?(((((map__27728.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27728.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27728):map__27728);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27728__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27728__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27728__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__27730){
var vec__27731 = p__27730;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27731,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27731,(1),null);
var fexpr__27734_27750 = (cljs.core.truth_(ok)?h:e);
(fexpr__27734_27750.cljs$core$IFn$_invoke$arity$1 ? fexpr__27734_27750.cljs$core$IFn$_invoke$arity$1(result) : fexpr__27734_27750.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__27735){
var map__27736 = p__27735;
var map__27736__$1 = (((((!((map__27736 == null))))?(((((map__27736.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27736.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27736):map__27736);
var opts = map__27736__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27736__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27736__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27736__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27736__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27736__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
