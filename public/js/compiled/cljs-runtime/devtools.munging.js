...
var o29406 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29406["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29407 = temp__5733__auto____$1;
return (o29407["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27647__auto__ = f;
return (o__27647__auto__["toString"]).call(o__27647__auto__);
} else {
return "";
}
}catch (e29408){var _ = e29408;
return "";
}});
...
try{var o__27647__auto___29628 = t;
(o__27647__auto___29628["cljs$lang$ctorPrWriter"]).call(o__27647__auto___29628,t,writer);
}catch (e29410){var __29632 = e29410;
}
...
var char_code = (function (){var o__27647__auto__ = (new String(char$));
return (o__27647__auto__["charCodeAt"]).call(o__27647__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27647__auto__ = String;
return (o__27647__auto__["fromCharCode"]).call(o__27647__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29413 = num_code;
switch (G__29413) {
case (1):
return (185);
...
var o__27647__auto__ = String;
return (o__27647__auto__["fromCharCode"]).call(o__27647__auto__,superscript_code);
});
/**
...
}catch (e29427){var _e__27677__auto__ = e29427;
return false;
}})())){
...
var vec__29428 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29428,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29435 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29435["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29436 = temp__5733__auto____$1;
return (o29436["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29439){
var vec__29440 = p__29439;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29440,(0),null);
...
var G__29652 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29653 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29652;
remaining_tokens = G__29653;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29437){
var G__29438 = cljs.core.first(seq29437);
var seq29437__$1 = cljs.core.next(seq29437);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29438,seq29437__$1);
}));
...
var vec__29451 = cljs.core.split_with((function (p1__29448_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29448_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29451,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29451,(1),null);
...
var vec__29459 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29459,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29459,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29660 = cljs.core.rest(remaining_tokens);
var G__29661 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29660;
name_tokens = G__29661;
continue;
} else {
...
var vec__29464 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29464,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29464,(1),null);
var vec__29467 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29467,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29467,(1),null);
var vec__29470 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29470,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29470,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29470,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29470,(3),null);
...
var vec__29484 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29493 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29493,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29493,(1),null);
var vec__29496 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29496,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29496,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29510 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29510) : devtools.munging.parse_fn_info_deep.call(null,G__29510));
})()));
}
} else {
return fn_info;
...
var G__29683 = (arity + (1));
var G__29684 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29516){
var vec__29519 = p__29516;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29519,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29519,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29526_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29526_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29527_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29527_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___29685 = arguments.length;
var i__4790__auto___29687 = (0);
while(true){
if((i__4790__auto___29687 < len__4789__auto___29685)){
args__4795__auto__.push((arguments[i__4790__auto___29687]));

var G__29688 = (i__4790__auto___29687 + (1));
i__4790__auto___29687 = G__29688;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29532){
var vec__29533 = p__29532;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29533,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29528){
var G__29529 = cljs.core.first(seq29528);
var seq29528__$1 = cljs.core.next(seq29528);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29529,seq29528__$1);
}));
...
var G__29548 = arg;
var G__29548__$1 = (((G__29548 instanceof cljs.core.Keyword))?G__29548.fqn:null);
switch (G__29548__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29562__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29562__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29562__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29562__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29563 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(5),null);
...
var o__27647__auto__ = f;
return (o__27647__auto__["getBasis"]).call(o__27647__auto__);
});
/**
...
}catch (e29573){var _e__27677__auto__ = e29573;
...
var G__29703 = (obj[cljs.core.first(path)]);
var G__29704 = cljs.core.rest(path);
obj = G__29703;
path = G__29704;
continue;
} else {
...
var _STAR_ = (function (accum,p__29584){
var vec__29585 = p__29584;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29585,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29585,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29591){
var vec__29592 = p__29591;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(2),null);
...
var post_process = (function (p__29611){
var vec__29612 = p__29611;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29612,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29612,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29606_SHARP_){
return (obj[cljs.core.first(p1__29606_SHARP_)]);
}),sorted_matches);
