...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k27173,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k27173,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__27178){
var vec__27179 = p__27178;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27179,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27179,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27172){
var self__ = this;
var G__27172__$1 = this;
return (new cljs.core.RecordIter((0),G__27172__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27174,other27175){
var self__ = this;
var this27174__$1 = this;
return (((!((other27175 == null)))) && ((this27174__$1.constructor === other27175.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.status,other27175.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.body,other27175.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.status_text,other27175.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.headers,other27175.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.was_aborted,other27175.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27174__$1.__extmap,other27175.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__27172){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__27182 = cljs.core.keyword_identical_QMARK_;
var expr__27183 = k__4447__auto__;
if(cljs.core.truth_((pred__27182.cljs$core$IFn$_invoke$arity$2 ? pred__27182.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__27183) : pred__27182.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__27183)))){
return (new ajax.protocols.Response(G__27172,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27182.cljs$core$IFn$_invoke$arity$2 ? pred__27182.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__27183) : pred__27182.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__27183)))){
return (new ajax.protocols.Response(self__.status,G__27172,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27182.cljs$core$IFn$_invoke$arity$2 ? pred__27182.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__27183) : pred__27182.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__27183)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__27172,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27182.cljs$core$IFn$_invoke$arity$2 ? pred__27182.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__27183) : pred__27182.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__27183)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__27172,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27182.cljs$core$IFn$_invoke$arity$2 ? pred__27182.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__27183) : pred__27182.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__27183)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__27172,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__27172),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__27172){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__27172,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__27176){
var extmap__4478__auto__ = (function (){var G__27185 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27176,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__27176)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__27185);
} else {
return G__27185;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__27176),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__27176),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__27176),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__27176),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__27176),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
